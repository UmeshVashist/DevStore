...
export function FolderPanel({
  ...
  return (
    <motion.div
      ...
      className="glass-card p-6 mb-8 relative z-20"
    >
      <h2 className="text-white font-semibold text-lg mb-4">Folder Management</h2>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-6">
        ...
        <label className="btn-ghost flex items-center justify-center gap-2 flex-1 cursor-pointer text-white/80">
          <input
            type="file"
            multiple
            className="hidden"
        ...
        >
          ...
          <form onSubmit={handleCreate} className="flex gap-2">
            <input
              ...
              className="glass-input flex-1 px-4 py-2.5 text-white placeholder:text-white/40"
              autoFocus
            />
            <button type="submit" disabled={creating || !folderName.trim()} className="btn-primary px-4">
